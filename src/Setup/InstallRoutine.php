...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6002';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
leVv2==
--------------------------------------------------------------------------------';
