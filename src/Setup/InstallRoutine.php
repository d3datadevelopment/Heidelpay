...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6122';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
Hgdv2==
--------------------------------------------------------------------------------';
